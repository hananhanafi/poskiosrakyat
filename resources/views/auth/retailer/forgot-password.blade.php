...
@section('card_content')
                <div class="register-form">
                    <p class="h6 mt-3 mb-4"><b>Lupa Password?</b></p>
                    ...
                    <p>Kembali ke halaman <a href="{{url('/retailer/login')}}" class="btn text-primary pl-0">masuk</a></p>
                </div>
                ...
                <form id="form-hidden-phone-number" action="{{ url('retailer/forgot-password/otp-verified') }}" method="get">
                    @csrf
