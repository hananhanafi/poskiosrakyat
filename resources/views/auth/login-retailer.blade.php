...
<div class="login-box">
  ...
  <div class="card card-outline" style="transform: translateZ(0);">
    <div class="card-header text-center">
      <p class="h1"><b>Point of Sale</b></p>
      <p class="h1" style="color: #F47500"><b>KiosRakyat</b></p>
    </div>
    <div class="card-body">
      ...
      @endif
      <form action="{{ url('login/retailer') }}" method="post">
        @csrf
      ...
      <p class="mb-0">
        <a href="{{url('/login-otp')}}" class="text-center">Masuk menggunakan Kode SMS</a>
      </p>
      </center> -->
    </div>
    <!-- /.card-body -->
